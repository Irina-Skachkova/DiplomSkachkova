...
Для информации все инструменты, которые используются в подсистемах Обслуживание клиентов и Заработная плата, размещены в подсистеме Добавленные Объекты.
...
Отчеты по зарплате и отпускам должны быть предоставлены кадровикам-расчетчикам.
